...
public class PanelNumeros extends JPanel {
    ...
    public void invertirPanel() {
        
        for (int i = 0; i < 8; i++) {
            
            this.numeros[7-i].setLabel(null);
            //Le insertamos un label con el numero en cuestion
            this.numeros[7-i].setLabel(String.valueOf((i+1)));

            //Seteamos su color en blanco
            this.numeros[7-i].setBackground(Color.WHITE);

            //Y lo desabilitamos para ser clickeado
            this.numeros[7-i].setEnabled(false);
